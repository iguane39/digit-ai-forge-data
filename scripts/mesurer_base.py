#!/usr/bin/env python
"""mesurer_base.py — service cat-dat-08 « Mesurer une base connectée » (RD-3, Produit-10 13/08).
...
Porté du run Produit-10 (scripts/dbx_sql.py, 7,2 M de lignes mesurées en conditions réelles),
...
def cible(profil: str, warehouse: str) -> dict:
    """L'identite de l'instance interrogee — TF-0580 (retour Produit-10 du 24/08/2026).
