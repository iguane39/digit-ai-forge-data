...
| Kimball — modélisation dimensionnelle (bus matrix, star schema) | https://www.kimballgroup.com/data-warehouse-business-intelligence-resources/kimball-techniques/dimensional-modeling-techniques/ | 0.8 | **retenu (barre, 07/09/2026)** | niveau du verbe **modéliser** : granularité, dimensions conformes, clés de substitution, dimension temps, changements lents, matrice en bus → M1-M6 (`oracle-modeliser.mjs`, TF-0860) — jusqu'au 07/09 « pas d'oracle », vocabulaire seul |
| dbt-core — discipline d'un projet de transformation (ref/source, tests attachés, docs générées) | https://github.com/dbt-labs/dbt-core | 0.9 | **retenu (barre, 07/09/2026)** | niveau du verbe **transformer** : TR1-TR6 (`oracle-transformer.mjs`, TF-0861) — lit les artefacts de l'outil (manifest, run_results, catalog), jamais un YAML réinterprété |
| TMDL — Tabular Model Definition Language (format texte d'un modèle sémantique Power BI / projet PBIP) | https://learn.microsoft.com/power-bi/developer/projects/projects-dataset#tmdl-format | 0.8 | **retenu (format d'entrée, 08/09/2026)** | entrée du verbe **traduire-modele-semantique** (`scripts/traduire-modele-semantique.mjs`, TF-0894) : le modèle sémantique EST un dossier de fichiers texte, donc lisible sans capacité payante ni point de terminaison XMLA. Format d'entrée PARTAGÉ avec `oracles/verifier-modele-semantique.mjs` de forge-audit (qui juge ; ici on traduit) — un seul artefact côté client, deux usages, aucun oracle dupliqué |
